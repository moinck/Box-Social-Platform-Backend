            ...
            <div class="authentication-inner py-6">
                ...
                <div class="card p-md-7 p-1">
                    ...
                    <div class="card-body mt-1">
                        ...
                        <form id="formAuthentication" class="mb-5" action="{{ route('register.check') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-floating form-floating-outline mb-5">
                                <input type="number" class="form-control" id="fca_number" min="0" name="fca_number" placeholder="Enter your FCA Number" autofocus>
                                <label for="username">FCA Number</label>
                            </div>
                            <div class="form-floating form-floating-outline mb-5">
