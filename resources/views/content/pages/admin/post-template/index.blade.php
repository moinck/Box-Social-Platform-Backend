        ...
        <div class="card-header d-flex flex-column flex-md-row border-bottom user-table-header">
            ...
            <div class="dt-action-buttons text-end pt-3 pt-md-0">
                <div class="dt-buttons btn-group flex-wrap"> 
                    <a href="http://178.128.45.173:9163/admin/create-templates?token=Nm1tSmhGM2JzYUJCbGNPcXY4ZXdudz09" target="_blank" class="btn btn-secondary btn-primary waves-effect waves-light" 
