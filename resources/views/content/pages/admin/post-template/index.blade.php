        ...
        <div class="card-header d-flex flex-column flex-md-row border-bottom user-table-header">
            ...
            <div class="dt-action-buttons text-end pt-3 pt-md-0">
                <div class="dt-buttons btn-group flex-wrap"> 
                    <a href="https://www.boxsocials.com/admin/create-templates?token={{ $currentAdminToken ?? '' }}" target="_blank" class="btn btn-secondary btn-primary waves-effect waves-light" 
